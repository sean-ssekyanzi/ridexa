...
from src.domain.use_cases import AbstractUserService
...
class UserService(AbstractUserService):
    def __init__(self, repo: AbstractUserRepository, auth_repo, event_dispatcher: AbstractDomainEventDispatcher | None = None):
        self._repo = repo
